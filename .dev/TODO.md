...
* \[~] **DungeonCleaning**: Add cleaning mechanics and area progression (player services wiring, enemy/building repositories, enemy entity + data module scaffolding, Building entity and BuildingService implemented with repository pattern)
